            ...
            <View style={[styles.flexCol, { gap: vw(5), paddingHorizontal: vw(7.5), paddingVertical: vw(4) }]}>
                <View style={[styles.flexRowEvenlyCenter, { gap: vw(4) }]}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={[componentStyle.noto16Bold, { color: wifiTypeSellected == 1 ? colorStyle.white : colorStyle.grey }]}>Mạng nội bộ</Text>
                ...
                <View>
                    ...
                    <TouchableOpacity
                        style={[styles.marginTop2vw, styles.flexRowBetweenCenter, { backgroundColor: colorStyle.white, padding: vw(4), borderRadius: vw(4) }]}
